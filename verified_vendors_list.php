...
try {
    ...
    $stmt = $pdo->prepare("
        ...
        ORDER BY account_type ASC, verified_at DESC
    ");
    ...
    $individual_vendors = array_values(array_filter($all_verified, function($kyc) {
        return $kyc['account_type'] === 'individual';
    }));
    
    $business_vendors = array_values(array_filter($all_verified, function($kyc) {
...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <h1>✅ Verified Vendors - TRUCK UNION</h1>
            <p>Successfully verified vendors confirmed by internal team</p>
        </div>

        <!-- Statistics -->
        <div class="stats-grid">
            <div class="stat-card">
                <h3>Total Verified Vendors</h3>
                <div class="number"><?php echo count($all_verified); ?></div>
            </div>
            <div class="stat-card">
                <h3>Individual Vendors</h3>
                <div class="number"><?php echo count($individual_vendors); ?></div>
            </div>
            <div class="stat-card">
                <h3>Business Vendors</h3>
                <div class="number"><?php echo count($business_vendors); ?></div>
            </div>
        </div>
                    ...
                    <?php foreach ($individual_vendors as $vendor): ?>
                        <div class="vendor-card individual">
                            <div class="card-header">
                                ...
                                <span class="account-badge individual">👤 Individual</span>
                            </div>
                            ...
                            <div class="info-section">
                                ...
                                <div class="info-row">
                                    ...
                                    <div class="info-content">
                                        ...
                                        <div class="info-value"><?php echo date('d M Y, h:i A', strtotime($vendor['verified_at'])); ?></div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Business Vendors Tab -->
        <div id="business-tab" class="tab-content">
            <div class="vendors-grid">
                <?php if (empty($business_vendors)): ?>
                    <div class="empty-state">
                        <div class="empty-icon">🏢</div>
                        <div class="empty-text">No verified business vendors yet</div>
                    </div>
                <?php else: ?>
                    <?php foreach ($business_vendors as $vendor): ?>
                        <div class="vendor-card business">
                            <div class="card-header">
                                <div class="vendor-name"><?php echo htmlspecialchars($vendor['name']); ?></div>
                                <span class="account-badge business">🏢 Business</span>
                            </div>
